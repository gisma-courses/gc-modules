...
description: "TWe offer weekly input with a new course unit. After a brief input, the exercises are presented, which should be worked on to successfully complete the assignments."
author: Chris Reudenbach, Philipps University Marburg (PUM)
date: "2021-11-13"
date-format: "DD.MM.YYYY"
title-block-banner: ../images/gi/diffusion-sp.png
